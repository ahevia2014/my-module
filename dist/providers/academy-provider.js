...
var AcademyProvider = /** @class */ (function () {
    ...
    AcademyProvider.prototype.CenterControl = function (controlDiv, map, google) {
    ...
    AcademyProvider.prototype.createCenter = function (map, google) {
        var centerControlDiv = document.createElement('div');
        var centerControl = this.CenterControl(centerControlDiv, map, google);
        //   centerControlDiv.index = 1;
        map.controls[google.maps.ControlPosition.RIGHT_CENTER].push(centerControlDiv);
    };
    AcademyProvider.prototype.clearSelection = function () {
        if (selectedShape) {
    ...
    AcademyProvider.prototype.setSelection = function (shape) {
    ...
    AcademyProvider.prototype.deleteSelectedShape = function () {
        if (selectedShape) {
            selectedShape.setMap(null);
        }
    };
    AcademyProvider.prototype.selectColor = function (color) {
        selectedColor = color;
    ...
    AcademyProvider.prototype.setSelectedShapeColor = function (color, google) {
        if (selectedShape) {
    ...
    AcademyProvider.prototype.makeColorButton = function (color, google) {
    ...
    AcademyProvider.prototype.buildColorPalette = function (google) {
    ...
    AcademyProvider.prototype.createDrawingTool = function (map, google) {
    ...
    AcademyProvider.prototype.calcRoute = function (start, end, google, map, showPeajes, showGrifos) {
                    ...
                    if (showPeajes) {
                        for (var x = 0; x < markers.length; x++) {
                            ...
                            if (google.maps.geometry.poly.isLocationOnEdge(curPosition, new google.maps.Polyline({ path: response.routes[i].overview_path }), 0.0005)) {
                                ...
                                var valor = tarifas.findIndex(function (id) { return id == markers[x].label; }, 1);
    ...
    AcademyProvider.prototype.highlightRoute = function (index, google, map) {
        ...
        for (var j in polylines) {
            if (j == index) {
                ...
                var pos = rutas[j].overview_path.length / 2;
                costo = (distancia / 1000 / modelo) * combustibles[0].precio;
                var tipo_com = combustibles[0].tipo + " " + combustibles[0].subtipo;
    ...
    AcademyProvider.prototype.calcDistance = function (p1, p2, google) {
        return (google.maps.geometry.spherical.computeDistanceBetween(p1, p2) / 1).toFixed(3);
    };
    AcademyProvider.prototype.currentPos = function (google, map) {
    ...
    AcademyProvider.prototype.handleLocationError = function (browserHasGeolocation, infoWindow, pos, map) {
        infoWindow.setPosition(pos);
    ...
    AcademyProvider.prototype.cargarLocations = function (google) {
    ...
    AcademyProvider.prototype.cargarGrifos = function (google) {
    ...
    AcademyProvider.prototype.buscarGrifos = function (pos, google, map) {
        var distancia;
        var featurePos;
    ...
    AcademyProvider.prototype.setMapOnAll = function (map) {
    ...
    AcademyProvider.prototype.clearMarkers = function () {
        AcademyProvider.prototype.setMapOnAll(null);
    };
    // Shows any markers currently in the array.
    // Shows any markers currently in the array.
    AcademyProvider.prototype.showMarkers = 
    // Shows any markers currently in the array.
    function (map) {
    ...
    // Deletes all markers in the array by removing references to them.
    AcademyProvider.prototype.deleteMarkers = 
    // Deletes all markers in the array by removing references to them.
    function () {
        AcademyProvider.prototype.clearMarkers();
        markers = [];
